...
public static class rlImGui {
    ...
    private static void FrameEvents() {
        ...
        if ((io.ConfigFlags & ImGuiConfigFlags.NavEnableGamepad) != 0 && Raylib.IsGamepadAvailable(0)) {
            ...
            HandleGamepadButtonEvent(io, GamepadButton.GAMEPAD_BUTTON_LEFT_TRIGGER_1, ImGuiKey.GamepadR1);
            HandleGamepadButtonEvent(io, GamepadButton.GAMEPAD_BUTTON_LEFT_TRIGGER_2, ImGuiKey.GamepadR2);
            ...
            // left stick
            HandleGamepadStickEvent(io, GamepadAxis.GAMEPAD_AXIS_LEFT_X, ImGuiKey.GamepadLStickLeft,
                ImGuiKey.GamepadLStickRight);
            HandleGamepadStickEvent(io, GamepadAxis.GAMEPAD_AXIS_LEFT_Y, ImGuiKey.GamepadLStickUp,
                ImGuiKey.GamepadLStickDown);

            // right stick
            HandleGamepadStickEvent(io, GamepadAxis.GAMEPAD_AXIS_RIGHT_X, ImGuiKey.GamepadRStickLeft,
                ImGuiKey.GamepadRStickRight);
            HandleGamepadStickEvent(io, GamepadAxis.GAMEPAD_AXIS_RIGHT_Y, ImGuiKey.GamepadRStickUp,
